...
//console.log(Object.values(inventory[32]));
...
//console.log(inventory[inventory.length-1].car_make );
//console.log(inventory[inventory.length-1].car_model );
let finCar = `Last car is a ${inventory[inventory.length-1].car_make} ${inventory[32].car_model}`
...
let carModels = inventory.sort(compare);
